...
func (od *ObservationDelete) Where(ps ...predicate.Observation) *ObservationDelete {
...
func (od *ObservationDelete) sqlExec(ctx context.Context) (int, error) {

...
const (
	...
	// EdgeDatasetParams holds the string denoting the dataset_params edge name in mutations.
	EdgeDatasetParams = "dataset_params"
	...
	// DatasetParamsTable is the table the holds the dataset_params relation/edge.
	DatasetParamsTable = "dataset_params"
	// DatasetParamsInverseTable is the table name for the DatasetParams entity.
	// It exists in this package in order to avoid circular dependency with the "datasetparams" package.
	DatasetParamsInverseTable = "dataset_params"
	// DatasetParamsColumn is the table column denoting the dataset_params relation/edge.
	DatasetParamsColumn = "dataset_dataset_params"

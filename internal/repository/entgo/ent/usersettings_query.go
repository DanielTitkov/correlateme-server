...
// Returns a *NotSingularError when exactly one UserSettings entity is not found.
...
// Returns a *NotSingularError when exactly one UserSettings ID is not found.
...
func (usq *UserSettingsQuery) Select(field string, fields ...string) *UserSettingsSelect {
	...
	return &UserSettingsSelect{UserSettingsQuery: usq}
}
...
func (uss *UserSettingsSelect) Scan(ctx context.Context, v interface{}) error {
	...
	uss.sql = uss.UserSettingsQuery.sqlQuery(ctx)
